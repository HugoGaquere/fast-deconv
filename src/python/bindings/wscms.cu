...
void bind_wscms(py::module_& m)
{
  ...
  py::class_<wscms::wscms_result>(wscms_module, "WscmsResult")
      ...
      .def_readonly("stop_flux", &wscms::wscms_result::stop_flux)
  ...
  py::class_<wscms::Wscms>(wscms_module, "Wscms")
      ...
      .def_property("flux_threshold", &wscms::Wscms::flux_threshold, &wscms::Wscms::set_flux_threshold)
      .def_property("stop_rms_factor", &wscms::Wscms::stop_rms_factor, &wscms::Wscms::set_stop_rms_factor)
      .def_property("stop_peak_factor", &wscms::Wscms::stop_peak_factor, &wscms::Wscms::set_stop_peak_factor)
      .def_property("stop_cycle_factor", &wscms::Wscms::stop_cycle_factor, &wscms::Wscms::set_stop_cycle_factor)
      .def_property("stop_sidelobe_level", &wscms::Wscms::stop_sidelobe_level,
                    &wscms::Wscms::set_stop_sidelobe_level)
