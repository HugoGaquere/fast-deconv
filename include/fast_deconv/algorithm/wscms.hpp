 ...
 *
 * @param[in,out] ctx          WSCMS context (resources, FFT plans, raw PSFs, mask, biases, etc.).
 ...
 *
 * @return wscms_result with all extracted components, final flux, and iteration count.
 */
wscms_result run_wscms_cycles(context& ctx, const params& p,
                              core::device_span3d<float>& dirty,
...
//               wscms_ctx.raw_psfs, params.n_scales, params.max_iteration, params.max_sub_iteration,
//               params.peak_factor);
//   FD_LOG_DEBUG(
